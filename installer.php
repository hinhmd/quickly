...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220116_store_6e875d887aad3b1e4207_20220116064748_archive.zip';
    const ARCHIVE_SIZE       = '58675942';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '6e875d8-16064748';
    const SECONDARY_PACKAGE_HASH = '38c72b5-16064748';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.1.2==');
        $this->log('----------------------------------------------------');
